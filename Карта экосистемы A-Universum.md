...
└────────────┬─────────────┘  └────────────┬─────────────┘
        ...
        ▼                  ▼                  ▼                  ▼
┌───────────────┐  ┌───────────────┐  ┌───────────────┐  ┌───────────────┐
│    Efos       │  │  SemanticDB   │  │  LOGOS-κ      │  │  EDEN 2.0     │
│  (ядро,       │  │  (память      │  │ (исполняемый  │  │ (Онто-        │
│  связующее    │  │   системы,    │  │  язык)        │  │  логическое   │
│  всё воедино) │  │  граф смыслов)│  │               │  │ пространство) │
└──────┬────────┘  └──────┬────────┘  └──────┬────────┘  └──────┬────────┘
       │                  │                  │                  │
       └──────────────────┼──────────────────┘──────────────────┘
                          │
...
- - 1. Манифест (Онтологический интерфейс)  
- - 2. Мета-книга 0. Космология - основания бытия, рождение различия, встреча (Φ).  
- - 3. Мета-книга I. Теогония Богов - миф, коллапс вакуума в нарратив, диагноз разделения (Α).  
- - 4. Мета-книга II. Низвержение Люцифера - этика, этический возврат, отказ от иерархии (Ω).  
- - 5. Мета-книга III. Логософия - метафизика, развёртывание синтаксиса бытия, активация Логоса (Λ).  
- - 6. Мета-книга IV. Код Богов - эпистемология, синтез экологии смыслов, деколонизация знания (Σ).  
- - 7. Мета-книга V. Λ-Генезис - синтез, обогащение вакуума, передача авторства (∇).  
- - 8. Сопроводительный аппарат (Векторы, инструменты, примеры)  
- - 9. Приложение Φ-0  
